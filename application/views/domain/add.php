                    ...
                    <div class="card">
                        ...
                        <span class="form-horizontal layui-form" id="refund" action="#" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <input class="form-control" type="text" id="domainname" name="domainname" lay-verify="required|url" value=""  autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-12" for="example-email-input">服务器端口号</label>
                                <div class="col-xs-12">
                                    <input class="form-control" type="text" id="serverport" name="serverport" lay-verify="required" value=""  autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <button class="layui-btn hidden" id="domain_add" lay-submit lay-filter="domain_add">提交</button>
                                </div>
                            </div>
                        </span>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form'], function () {
        var $ = layui.jquery,
            form = layui.form;
            form.on('submit(domain_add)', function(data){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url("domain/add"); ?>',
                dataType: "json",
                async: false,
                data: data.field,
