...
<script>
    ...
    layui.use(['table', 'treetable','upload'], function() {
        ...
        var dataTable=table.render({
            elem: '#test',
            url: '<?php echo base_url("supplier/index"); ?>',
            height: 700,
            size:'sm',
            toolbar: '#toolbarDemo',
            cols: [[
        ...
        table.on('toolbar(test)', function(obj){
            ...
            if(obj.event=="add"){
                location.href='<?php echo base_url("supplier/add"); ?>'
            }
        ...
        table.on('tool(test)', function(obj) {
            var data = obj.data;
            if (obj.event === 'edit') {
                    location.href='<?php echo base_url("supplier/add"); ?>/'+data.id;
            }
        });
    });
