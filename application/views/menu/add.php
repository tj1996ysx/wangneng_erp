                    ...
                    <div class="card-body">
                        <span class="form-horizontal" action="#" method="post" enctype="multipart/form-data" onsubmit="return false;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <input class="form-control" type="text" id="model" name="model" placeholder="模块">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-12" for="example-email-input">方法</label>
                                <div class="col-xs-12">
                                    <input class="form-control" type="text" id="action" name="action" placeholder="方法">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-12" for="example-email-input">排序</label>
                                <div class="col-xs-12">
                                    <input class="form-control" type="text" id="sort" name="sort" placeholder="排序" value="999">
                                </div>
                            </div>
