...
<script type="text/html" id="barDemo">
    <?php if (checkrole("blacklist", "add")) { ?>
...
<script>
    layui.use(['table', 'upload'], function () {
        ...
        var dataTable = table.render({
            elem: '#test',
            toolbar: '#barDemo',
            url: '<?php echo base_url("blacklist/index"); ?>',
            // height: 750,
            // cellMinWidth: 150,
            size: 'sm'
            , cols: [[
                {field: 'blackid', title: 'ID'},
                {field: 'devicecode', title: '设备硬件码'},
