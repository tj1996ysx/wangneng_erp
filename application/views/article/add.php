                    ...
                    <div class="card">
                        ...
                        <form class="form-horizontal layui-form" id="refund" action="#" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <input class="form-control" type="text" id="title" name="title" lay-verify="required" value=""  autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-12" for="example-email-input">描述</label>
                                <div class="col-xs-12">
                                    <textarea name="content"  id="content" type="text/plain" style="width:100%;height:500px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <button class="layui-btn hidden" id="article_add" lay-submit lay-filter="article_add">提交</button>
                                </div>
                            </div>
                        </form>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form'], function () {
        var $ = layui.jquery,
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url("article/add"); ?>',
                dataType: "json",
                async: false,
                data: data.field,
